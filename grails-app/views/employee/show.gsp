	...
	<body>
		...
		<div id="show-employee" class="content scaffold-show" role="main">
			...
			<ol class="property-list employee">
				...
				<g:if test="${employeeInstance?.employeeName}">
				<li class="fieldcontain">
					<span id="employeeName-label" class="property-label"><g:message code="employee.employeeName.label" default="Employee Name" /></span>
					
						<span class="property-value" aria-labelledby="employeeName-label"><g:fieldValue bean="${employeeInstance}" field="employeeName"/></span>
